<!-- This page displays the logo, login button, time and daily quote -->
<div id="logo"
    class="w3-half">
    <img src="images/logo.jpg"
        alt="HamroJerseyPasal Logo"
...
<div class="w3-half w3-right-align">
    ...
    if ($loggedIn)
      echo "<a class = 'w3-button w3-green w3-round w3-small' " .
...
<script>
//This script requests time updates from the server by setting AJAX
var request = null;
