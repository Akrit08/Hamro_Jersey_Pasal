<!-- Delete items to user's shopping cart and display the updated cart. -->
<?php
...
$query = "DELETE FROM my_OrderItem
...
$query = "SELECT COUNT(*) AS numItemsStillInOrder FROM my_OrderItem 
